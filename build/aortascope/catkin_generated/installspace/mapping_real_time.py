...
class PointCloudUpdater:
    ...
    def __init__(self):
        ...
        self.vis.create_window(window_name="vis2", width = 1920, height = 1080, left = 1000, top = 0)  # Custom window title
        self.vis.get_render_option().mesh_show_back_face = True
        self.vis.poll_events()
        self.vis.update_renderer()

        self.vis2 = o3d.visualization.Visualizer()        
        self.vis2.create_window(window_name="vis2", width = 1920, height = 1080, left = 0, top = 1000)  # Custom window title
        ...
        window_name = "vis"  # Replace with your window's title
        window_id = get_window_id(window_name)
        bring_window_to_front(window_id)

        window_name = "vis2"  # Replace with your window's title
        window_id = get_window_id(window_name)
        bring_window_to_front(window_id)
        ...
        window_name = "gui"  # Replace with your window's title
        window_id = get_window_id(window_name)
        bring_window_to_front(window_id)
    ...
    def save_image_and_transform_data(self):
        ...
        o3d.io.write_point_cloud(dataset_directory + pc_updater.dataset_name + bin_name +  "/smoothed_bspline_centreline.ply", pc_updater.processed_centreline)
    ...
    def funsr_done(self):
        ...
        ivus_funsr_mesh = o3d.io.read_triangle_mesh('/home/tdillon/datasets/' + self.dataset + '/full_lumen_mesh.ply')
    ...
    def tracking(self):
        ...
        self.vis2.remove_geometry(ivus_funsr_mesh)
        self.volumetric_far_point_cloud = o3d.geometry.PointCloud() 
        self.volumetric_near_point_cloud = o3d.geometry.PointCloud() 
        ...
        if(self.registered_ct ==1):
            ...
            self.registered_ct_lineset = o3d.io.read_line_set('/home/tdillon/datasets/' + self.dataset + '' + '/final_registration.ply')
            self.registered_ct_mesh = o3d.io.read_triangle_mesh('/home/tdillon/datasets/' + self.dataset + '' + '/final_registration_mesh.ply')
            ...
            self.centerline_pc = o3d.io.read_point_cloud('/home/tdillon/datasets/' + self.dataset + '' + '/centerline_pc.ply')
